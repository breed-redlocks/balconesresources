...
session_start();
	...
	$componentName = "Recruiting Log In";
	
	// NAME OF DIRECTORY COMPONENT IS IN
	$componentLink = 'recruitinglogin';
	...
	$subnav[0]['title'] = 'Add Log Ins';
	$subnav[0]['action'] = 'add';
	$subnav[1]['title'] = 'List Log Ins';
	$subnav[1]['action'] = '';
	...
	$items[1]['name'] 		= 'username';
	$items[1]['type'] 		= 'text';
	$items[1]['lable'] 		= 'Username';
	$items[1]['display'] 	= 'yes';
	$items[1]['displayWidth'] = '200px';
	$items[1]['displayWordLimit'] 	= '100';
	$items[1]['edit'] 		= 'yes';
	
	$items[2]['name'] 		= 'password';
	$items[2]['type'] 		= 'text';
	$items[2]['lable'] 		= 'Password';
	$items[2]['display'] 	= 'yes';
