...
define('NICUPLOAD_PATH', '../rsrc/client-uploads'); // Set the path (relative or absolute) to
                                      // the directory to save image files
                                      
define('NICUPLOAD_URI', '/rsrc/client-uploads');   // Set the URL (relative or absolute) to
