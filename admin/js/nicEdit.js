...
var nicEditorConfig = bkClass.extend({
	...
	buttonList : ['save','bold','italic','underline','left','center','right','justify','ol','ul','fontSize','fontFormat','indent','outdent','image','upload','link','unlink'],
...
var nicEditorPanel = bkClass.extend({
	construct : function(e,options,nicEditor) {
		...
		this.panelContain = new bkElement('DIV').setStyle({overflow : 'hidden', width : '85%', border : '1px solid #cccccc', backgroundColor : '#efefef'}).addClass('panelContain');
